...
app.get('/team_stats', function(req, res) {
	...
	var num_wins = 'SELECT count(*) as wins FROM football_games WHERE home_score > visitor_score';
	var num_losses = 'SELECT count(*) as losses FROM football_games WHERE visitor_score > home_score';
	db.task('get-everything', task =>{
		return task.batch([
			task.any(all_games),
			task.any(num_wins),
...
app.get('/player_info/select_player', function(req, res) {
	...
	var games_played = 'SELECT COUNT(*) AS num FROM (SELECT id FROM football_players, football_games ' +
